...
//1.Enter 3 numbers from keyboard à1, à2 è à3. Switch their places , so that a1 becomes a2, a2 = a3, a3 = a1;
...
//		thirdNum = firstNum; // a3 = a1; a3 becomes à1;
//		firstNum = secondNum; // a1 = a2; a1 becomes à2;
//		secondNum = temp; // a2 = a3 (temp); a2 becomes à3;
